...
function App() {
  ...
  function loadAndDownloadSlides(isHymn: boolean) {
    ...
    if (
      selectedTheme === THEME_OPTIONS.CUSTOM &&
      (!customSlidesData || !customSlidesData.masterSlide || !customSlidesData.defaultSlide)
    ) {
  ...
  return (
    <div>
      ...
      <div className="text-center">
        <a
          className="nav-link px-1 mx-1 py-2"
          href="https://github.com/renanbandeira"
          target="_blank"
